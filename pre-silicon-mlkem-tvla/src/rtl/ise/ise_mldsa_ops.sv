...
// ============================================================================
//
// File        : ise_mldsa_ops.sv
// Description : ML-DSA-specific polynomial decomposition operations.
//               Implements Power2Round and Decompose (HighBits/LowBits)
//               as defined in FIPS 204 for ML-DSA-44, ML-DSA-65, and
//               ML-DSA-87 parameter sets.
//
// Target      : ~180 LUTs
// Latency     : 1 cycle (combinational result, registered output)
//
// ============================================================================
