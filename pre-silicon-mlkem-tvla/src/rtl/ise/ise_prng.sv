...
//
// File        : ise_prng.sv
// Description : xoshiro128++ PRNG with seed and consume interface.
//               Provides 32-bit random words for masked operations and
//               randomness generation within the SCA_Pro_PQC coprocessor.
//               128-bit internal state (4 x 32-bit words), seeded via
//               the SEED_PRNG instruction.
//
// Target      : ~180 LUTs
// Latency     : Combinational output; state advances on consume_i
//
// ============================================================================
